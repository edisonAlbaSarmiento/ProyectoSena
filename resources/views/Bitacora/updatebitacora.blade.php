  ...
  <section class"row">
    <article class="col-md-8 col-md-offset-1">
      <div class="card-panel1 hoverable1">
        <div class="panel panel-heading"><center><h1>Actualizar Formato de Seguimiento Etapa Productiva</h1></center></div>
          <HR width=100% align="top">
              {!! Form::model($bitacora,['route'=>'bitacora/update','method'=>'put','novalidate']) !!}
