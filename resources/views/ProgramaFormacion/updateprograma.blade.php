  ...
  <section class"row">
    <article class="col-md-8 col-md-offset-1">
      <div class="card-panel1 hoverable1" >
        <div class="panel panel-heading"><center><h1>Actualizar Programa Formacion</h1></center></div>
          <HR width=100% align="left"/>  
       {!! Form::model($programaformacion,['route'=>'programaformacion/update','method'=>'put','novalidate']) !!}
        {!! Form::hidden('id',$programaformacion->id) !!}
			  <section>
            <div class="row">
