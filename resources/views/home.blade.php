                      ...
                      <nav class="main-nav">
                        <ul>
                          <li class="has-dropdown links" data-content="pricing">
                            <a href="#0" tabindex="6"><i class="material-icons">account_circle</i>Usuario</a>
                          </li>
                                ...
                                <a href="#0" class="label">Usuario</a>
                                  <div class="content">
                                    <ul>                
                                        ...
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/compromiso') }}">Compromiso</a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/asistentes') }}">Asistentes</a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/invitados') }}">Invitados</a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/area') }}">Area</a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/ambiente') }}">Ambiente</a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/aprendiz') }}">Aprendiz</a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/actividades') }}"> Actividades </a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/bitacora') }}"> Bitacora </a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/entidad') }}"> Entidad </a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/programaformacion') }}"> Programa </a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/centroformacion') }}"> Centro  </a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/empleado') }}">Empleado</a></li>
                                        <li><a class="dr-icon dr-icon-fa " href="{{ url('/reportes') }}"> Reportes</a></li>
                                    </ul>
                                  </div>
                              </li>
                              <!--  -->
