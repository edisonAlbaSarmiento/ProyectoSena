...
<head>
  <meta charset="UTF-8">
  <title>Reporte Por Visita</title>
<style>
              ...
              <div class="box">
                ...
                <div class="box-body">
                 <br>
                  ...
                  <h3><center><b>REPORTE POR VISITAS</center></h3>
                  ...
                  <tbody>
                      <?php foreach($data as $cantidad){ ?>
                        <tr>
                          <td><center><?= $cantidad->nombreempleado?></center></td>
                          <td><center><?= $cantidad->empleado_count; ?></center></td>
                        </tr>
                  </tbody>
                  <?php  } ?>
