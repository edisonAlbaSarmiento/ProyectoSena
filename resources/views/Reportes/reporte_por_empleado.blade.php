              ...
              <div class="box">
                ...
                <div class="box-body">
                 <br>
                  ...
                  <h3><center><b>REPORTE POR EMPLEADO</center></h3>
                  <table class="table table-bordered">
                  <thead>
                     <tr>
                       <td id="letra"><center><b>Nombre </td>
                       <td id="letra"><center><b>Apellido</td>
                       <td id="letra"><center><b>Centro Formacion </td>
                       <td id="letra"><center><b>Rol</td>
                     </tr>
                  </thead>
                    <tbody>
                  <?php foreach($data as $empleado){ ?>
                    ...
                    <tr>
                    <td><center><?= $empleado->nombreempleado;?></center></td>
                    <td><center><?= $empleado->apellido; ?></center></td>
                    <td><center><?= $empleado->nombrecentro; ?></center></td>
                    <td><center><?= $empleado->nombrerol; ?></center></td>
                    </tr>
